...
export const About: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md space-y-6 text-xl">
      <h2 className="text-3xl font-bold border-b pb-2 mb-4">サイトの目的</h2>
      ...
      <h2 className="text-3xl font-bold border-b pb-2 mb-4">使用している素材について</h2>
      <p className="text-gray-700 leading-relaxed">
        画像やデータは主に 
      ...
      <h2 className="text-3xl font-bold border-b pb-2 mb-4">非商業利用について</h2>
      <p className="text-gray-700 leading-relaxed">
      ...
      <h2 className="text-3xl font-bold border-b pb-2 mb-4">免責事項</h2>
      <p className="text-gray-700 leading-relaxed">
        掲載している情報は可能な限り正確を期していますが、正確性を保証するものではありません。利用にあたっては自己責任でお願いします。
      </p>

      <h2 className="text-3xl font-bold border-b pb-2 mb-4">お問い合わせ先</h2>
      <p className="text-gray-700 leading-relaxed">
